    ...
    def run(self):
        try:
            for library in self._options.libraries:
                ...
                # file and closing StringIO object discards its data.
                # This is why close() is overridden later.
...
PATH can be a path to a library source file, library XML (generated by LibDoc)
or a directory containing many of these files. Directories given as PATHs
are recursively traversed for files like these. Multiple PATHs can be given.
